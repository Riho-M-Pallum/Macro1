...
We also plot the policy function and note that it has the expected concave shape. \# Now to check the Euler equation on the gridpoints
```{r}
alpha <- 0.36
beta  <- 0.95
delta <- 0.05
